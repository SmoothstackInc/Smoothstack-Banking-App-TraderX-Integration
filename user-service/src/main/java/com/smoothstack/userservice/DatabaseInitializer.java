...
public class DatabaseInitializer {
    ...
    public void initializeDatabase() {
        try {
            jdbcTemplate.queryForObject("SELECT COUNT(*) FROM public.app_user", Integer.class);
        } catch (Exception e) {
            jdbcTemplate.execute(createTableQuery);
        }

        Integer count = jdbcTemplate.queryForObject("SELECT COUNT(*) FROM public.app_user", Integer.class);
